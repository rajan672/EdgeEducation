...
<div class="col-sm-9 mt-5 text-center">
    <p class="bg-dark text-white bp-2">List of Programme </p>
    ...
    ?>
        ...
        <table class="table">
            ...
            while($row = $result->fetch_assoc()){  
                ...
                echo '<td>
                        <form action="editAcourseForm.php" method="POST" class="d-inline" >
...
<div>
    <a href="./addAcourseForm.php" class="btn btn-danger box" ><i class="fi-xwsuxl-plus-solid"></i></a>
</div>
</div><!-- container-fluid -->
